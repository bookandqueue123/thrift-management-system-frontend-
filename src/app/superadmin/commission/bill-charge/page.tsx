...
const BillChargeManager = () => {
  ...
  const fetchPlatformCharge = async () => {
    setLoading(true);
    try {
      const response = await fetch(`${apiUrl}api/bill-charge`, {
        headers: {
  ...
  const handleSubmit = async (e: { preventDefault: () => void }) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        showNotification(
          modalMode === "create"
            ? "Bill charge created successfully"
            : "Bill charge updated successfully",
          "success",
        );
      } else {
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        showNotification("Bill charge deleted successfully", "success");
      } else {
        const errorData = await response.json();
      ...
      <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
          <h1 className="mb-2 text-3xl font-bold text-gray-900">
            Bill Charge Management
          </h1>
          <p className="text-gray-600">
            Manage your Bill&apos;s commission percentage
          </p>
        </div>
          ...
          {loading && !showModal ? (
              ...
              <div className="rounded-lg border border-blue-200 bg-gradient-to-r from-blue-50 to-indigo-50 p-6">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Bill Commission</p>
                  </div>
                </div>
            ...
            <div className="p-8 text-center">
              ...
              <p className="mb-6 text-gray-600">
                Create a bill charge to start collecting commissions
              </p>
              <button
                    ...
                    <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                      ...
                      <div className="mt-2">
                        <p className="text-sm text-gray-500">
                          Are you sure you want to delete the bill charge? This
...
export default BillChargeManager;
