...
export default function CartPage() {
  ...
  // State to track product stock information
  ...
  // Update product stocks when products data is available
  useEffect(() => {
          ...
          <div className="rounded-lg border border-gray-200 bg-white p-6 shadow-sm lg:col-span-2">
            <div className="overflow-x-auto">
              <table className="min-w-full divide-y divide-gray-200">
                ...
                <tbody className="divide-y divide-gray-200 bg-white">
                  {safeCartItems.map((item) => {
                    const availableStock = productStocks[item.product?._id] || 0;
                    const isOutOfStock = availableStock <= 0;
                    const hasReachedStockLimit = item.quantity >= availableStock;
                        ...
                        <td className="whitespace-nowrap px-4 py-4">
                          <div className="flex w-24 items-center rounded border border-gray-300">
                            <button
                              ...
                              disabled={decreaseQuantityMutation.isPending || isOutOfStock}
                              className="px-2 py-1 text-sm font-medium hover:bg-gray-100 disabled:opacity-50"
                            >
                              −
                            </button>
