...
//     return isPromoCodeValid(item) ? item.promoCode.promoPercentage : 0;
//   };
...
const CurrentBill = () => {
  ...
  const handleMakePayment = async () => {
    ...
    try {
      ...
      if (errorMsg && errorMsg.toLowerCase().includes("promo code") && errorMsg.toLowerCase().includes("already used")) {
