...
//       if (item.isMandatory) {
//         amount = outstanding; // Full amount for mandatory items
//       } else {
//         amount = selectedPayments[item._id] || 0; // User input for non-mandatory items
//       }
      
//       if (isPromoCodeValid(item)) {
//         const discount = calculatePromoDiscount(item);
//         amount = Math.min(amount, outstanding + discount); // Ensure we don't exceed outstanding amount
//       }
