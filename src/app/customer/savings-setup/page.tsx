...
const Form = ({
  ...
  const {
    ...
    queryFn: async () => {
      return client
        .get(`/api/user/${user.organisation}`, {}) //populate this based onthee org
        .then((response) => {
  ...
  return (
    <div className="">
      ...
      <div className=" mx-[10%] mt-12 rounded-md  bg-white">
            ...
            <div className="mb-4">
              <div className="">
                ...
                <span className="ml-4 text-sm font-medium capitalize text-[#7D7D7D]">
                  Individual(percentage-based) {customerOrganisation?.adminFee}%
                </span>
              </div>
              <div>
                <label className="inline-flex items-center">
                  ...
                  />
                  <span className="ml-4 text-sm font-medium capitalize text-[#7D7D7D]">
                    Savings amount based (daily) {formData.amount}
                  </span>
                </label>
              </div>
            </div>
